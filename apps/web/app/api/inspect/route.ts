...
import { optimizePrompt } from "@prompt-inspector/core/optimize";
...
export async function POST(request: Request) {
  ...
  const optimizations = optimizePrompt({ prompt }, inspection);

  return NextResponse.json({ inspection, optimizations });
}
